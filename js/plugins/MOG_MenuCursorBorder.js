 ...
 * @target MZ
 * @target MZ
 * @plugindesc (v1.0) コマンド選択に枠線を追加する。（DeepL翻訳）
 * @author Moghunter
 ...
 * @default 0
 *
 * @param Border X-Space (ボーダーXスペース)
 * @desc カーソルの境界のX軸を定義します。
 * @default 4
 *
 * @param Border Y-Space (ボーダーYスペース)
 * @desc カーソルの境界のY軸を定義します。
 * @default 4
 *
 * @help  
 * =============================================================================
